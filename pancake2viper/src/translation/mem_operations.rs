...
// FIXME: change this to match word size
impl<'a> ToViper<'a, viper::Stmt<'a>> for pancake::StoreBits {
    fn to_viper(self, ctx: &mut ViperEncodeCtx<'a>) -> viper::Stmt<'a> {
...
// TODO: how to model shared memory?
impl<'a> ToViper<'a, viper::Stmt<'a>> for pancake::SharedStoreBits {
    fn to_viper(self, ctx: &mut ViperEncodeCtx<'a>) -> viper::Stmt<'a> {
        let ast = ctx.ast;
        ast.method_call(
            "shared_store",
...
impl<'a> ToViper<'a, viper::Stmt<'a>> for pancake::SharedLoad {
    fn to_viper(self, ctx: &mut ViperEncodeCtx<'a>) -> viper::Stmt<'a> {
        let ast = ctx.ast;
        ast.method_call(
            "shared_load",
...
impl<'a> ToViper<'a, viper::Stmt<'a>> for pancake::SharedLoadBits {
    fn to_viper(self, ctx: &mut ViperEncodeCtx<'a>) -> viper::Stmt<'a> {
        let ast = ctx.ast;
        ast.method_call(
            "shared_load",
